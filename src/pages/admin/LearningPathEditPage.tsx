...
const AdminLearningPathEditPage = () => {
  ...
  const fetchCourses = async () => {
    try {
      ...
      const response = await getAllCourses({ limit: 100, skip: 0 })
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await learningPathService.updateLearningPath(id!, formData)
  ...
  if (!learningPath) {
    return (
      <div className="text-center py-8">
        <p className="text-gray-500 dark:text-gray-400">Learning path not found</p>
        <Button onClick={() => navigate("/admin/learning-paths")} className="mt-4">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Edit Learning Path</h1>
          <p className="text-gray-600 dark:text-gray-400 mt-2">Update the learning path details and course sequence</p>
        </div>
      </div>
...
export default AdminLearningPathEditPage
