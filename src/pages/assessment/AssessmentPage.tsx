...
const AssessmentPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchAssessmentAndQuestions = async () => {
      try {
        ...
        console.log(`Assessment Data 2 :::: ${JSON.stringify(assessmentData)}`);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // console.log(`Before navigating to result, print assessement ${JSON.stringify(assessment)}`)
...
//         setTimeRemaining(assessmentData.assessment.time_limit * 60); // Convert minutes to seconds

//         // Fetch questions for the assessment
//         const questionsData = await getQuestionByAssessmentId(id);
//         setQuestions(questionsData.questions);
...
//       // const score = Math.round((correctAnswersCount / totalQuestions) * 100); // Calculate percentage score
