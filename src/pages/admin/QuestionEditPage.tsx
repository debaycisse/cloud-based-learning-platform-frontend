...
// Define schema for question editing
  ...
  useEffect(() => {
    const fetchQuestion = async () => {
      try {
        ...
        setError(err.response?.data?.error || "Failed to fetch question details. Please try again.")
      } finally {
        setIsLoading(false)
      }
    }
  ...
  if (isLoading) {
    return (
      <div className="flex justify-center items-center h-64">
        ...
        <p className="ml-2 text-gray-600">Loading question...</p>
      </div>
    )
  }
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-gray-600 dark:text-gray-400">Update the question details</p>
      </div>
